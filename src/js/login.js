...
botaoCadastrarCliente.addEventListener("click", function () {
    ...
    const confirmarSenha = document.getElementById("cadastrarusuario-confirmarsenha").value;
    var u_acao = "cadastro";

    if (u_senha == confirmarSenha) {
        ...
        var divConfirmarSenha =  document.getElementById("divConfirmarSenha");
        if(!divConfirmarSenha.classList.contains("invalido")){
            const confirmarSenha = document.createElement("label");
            confirmarSenha.innerHTML = "As senhas não confere.";
            confirmarSenha.style.color = "red";
            divConfirmarSenha.classList.add("invalido");
            divConfirmarSenha.appendChild(confirmarSenha);
        }
        
    }
    //console.log(document.getElementById("cadastrarusuario-confirmarsenha").value);
});
...
botaoEsqueciSenha.addEventListener("click", function () {
    ...
    $.ajax({
        url: '../precofacil/src/php/cadastrocliente.php',
        method: 'POST',
        data: { 'acao': u_acao, 'email': u_email },
        dataType: 'json',
        success: function (retorno) {
